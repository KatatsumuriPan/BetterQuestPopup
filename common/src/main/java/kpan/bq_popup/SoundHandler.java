...
public class SoundHandler {
    ...
    public static final Identifier CHAPTER_COMPLETE_ID = new Identifier(ModReference.MOD_ID, "chapter_complete");
    public static final Identifier ALL_CHAPTERS_COMPLETE_ID = new Identifier(ModReference.MOD_ID, "all_chapters_complete");
